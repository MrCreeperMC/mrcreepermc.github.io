<?php
/*
 *	Made by Samerton | Revamped by John
...
class Stellar_Template extends TemplateBase {
	...
	public function __construct($cache, $smarty, $language, $user, $pages) {
		$template = array(
			...
			'author' => '<a href="https://ipolotech.com/" target="_blank">John</a>',
		);
...
$template = new Stellar_Template($cache, $smarty, $language, $user, $pages);
